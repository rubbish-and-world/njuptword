...
public:
    ...
    void recite_spell_c2e();
    void recite_spell_e2c();
    void recite_choice_c2e();
    void recite_choice_e2c();
...
void Card::recite_spell_c2e(){
    show_ch();
    string input = user_input();
    bool flag = (input == english);
    judge(flag);
}
void Card::recite_spell_e2c(){
    show_en();
    string input = user_input();
    bool flag = (input == chinese);
    judge(flag);
}
void Card::recite_choice_c2e(){
    show_ch();
